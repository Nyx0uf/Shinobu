...
final class SearchResultTableViewCell: UITableViewCell {
	...
	override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
		...
		self.imgDisclosure = UIImageView(image: #imageLiteral(resourceName: "cell-disclosure").withTintColor(.secondaryLabel), highlightedImage: #imageLiteral(resourceName: "cell-disclosure").withTintColor(themeProvider.currentTheme.tintColor))
		...
		self.btnPlay.selectedBackgroundColor = themeProvider.currentTheme.tintColor.withAlphaComponent(0.2)
		...
		self.btnPlay.setImage(#imageLiteral(resourceName: "search-cell-play").withTintColor(themeProvider.currentTheme.tintColor), for: .selected)
		self.btnPlay.setImage(#imageLiteral(resourceName: "search-cell-play").withTintColor(themeProvider.currentTheme.tintColor), for: .highlighted)
		...
		self.lblTitle.highlightedTextColor = themeProvider.currentTheme.tintColor
		...
		self.overlayView.backgroundColor = themeProvider.currentTheme.tintColor.withAlphaComponent(0.2)
...
extension SearchResultTableViewCell: Themed {
